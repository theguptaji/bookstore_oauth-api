...
func TestAccessTokenConstants(t *testing.T) {
	assert.EqualValues(t, expirationTime, 24, "expiration time should be 24 hrs")
}
...
func TestAccessTokenIsExpired(t *testing.T) {
	...
	assert.False(t, at.IsExpired(), "access token expired 3 hours from now should not be expired")
}
