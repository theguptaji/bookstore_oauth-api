...
import (
	...
	"github.com/theguptaji/bookstore_oauth-api/src/clients/cassandra"
...
func (r *dbRepository) Create(at access_token.AccessToken) rest_errors.RestErr {
	if err := cassandra.GetSession().Query(queryCreateAccessToken,
		...
		return rest_errors.NewInternalServerError("error when trying to save acces token in database", err)
	}
	return nil
}
